...
export const TrackContext = createContext<Tracking | null>(null);


export default function TrackProvider({ children }) {
  // const { currentPosition, position } = useContext(AuthContext);
  ...
  const [watchedPosition, setWatchedPosition] = useState<GeoPosition | null>(null);
  ...
  console.log({ PPloc: location, PPobs: observing })
  // useEffect(() => {
  //   console.log({ currentPos: currentPosition, pos: position })
  // })
