...
// import {estimatedCarbonFP} from '../utils/estimates';
...
const VehicleDetailsScreen = ({navigation, route}) => {
  ...
  const {getItem, setItem} = useAsyncStorage(storage_keys.wallet);
  ...
  // useEffect(() => {
  //   estimatedCarbonFP({
  //     api: {initialCOe, fuel: {selectedFuel}, type: {selectedType}},
  //   }).then(result => setCarbonFP(result));
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        {/* <GradientText style={styles.text_header}>& </GradientText> */}
        <GradientText style={styles.text_header}>Carbon FootPrint</GradientText>
      </View>
      ...
      <Animatable.View style={styles.footer}>
        <ScrollView>
          ...
          <Text style={styles.text_footer}>
            {' '}
            <Fontiso name="car" color="green" size={17} /> Model, Make & Year
          </Text>
          <MultipleSelectList
          ...
          <Text style={styles.text_footer}>
            {' '}
            <MaterialIcons name="electric-car" color="green" size={15} /> Type
          </Text>
          <SelectList
          ...
          <Text style={styles.text_footer}>
            {' '}
            <MaterialCommunityIcons name="fuel" color="green" size={17} /> Fuel
          </Text>
          <SelectList
          ...
          {/* Color */}
          <Text style={styles.text_footer}>
            <Icon name="color-fill" color="green" size={20} />
            Color
          </Text>
          <SelectList
          ...
          <Text style={styles.text_footer}>
            {' '}
            <FontAwesome name="registered" color="green" size={17} /> Car
            Registration
          </Text>
          <View style={styles.action}>
            <TextInput
