...
// const keys = 'AIzaSyDNaKE-KYiemHsLIWpjRaZ8MpkZ7T3TkHE';
const Map = () => {
  ...
  const getTravelTime = async () => {
    const URL = `https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins=${origin.description}&destinations=${destination.description}&key=${keys.GOOGLE_MAP_APIKEY}`;
